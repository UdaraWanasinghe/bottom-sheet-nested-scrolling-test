...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private final BottomSheetBehavior.StateSettlingTracker stateSettlingTracker = new BottomSheetBehavior.StateSettlingTracker();
    ...
    public Parcelable onSaveInstanceState(@NonNull CoordinatorLayout parent, @NonNull V child) {
        return new BottomSheetBehavior.SavedState(super.onSaveInstanceState(parent, child), this);
    }
    ...
    public void onStopNestedScroll(
        ...
        @BottomSheetBehavior.StableState int targetState;
     ...
     * @see #getSaveFlags()
     */
    public void setSaveFlags(@BottomSheetBehavior.SaveFlags int flags) {
     ...
     * @param callback The callback to notify when bottom sheet events occur.
     */
    public void addBottomSheetCallback(@NonNull BottomSheetBehavior.BottomSheetCallback callback) {
     ...
     */
    public void removeBottomSheetCallback(@NonNull BottomSheetBehavior.BottomSheetCallback callback) {
     ...
     */
    public void setState(@BottomSheetBehavior.StableState int state) {
    ...
    private void updateDrawableForTargetState(@BottomSheetBehavior.State int state, boolean animate) {
        if (state == STATE_SETTLING) {
    ...
    private void restoreOptionalState(@NonNull BottomSheetBehavior.SavedState ss) {
    ...
    private void startSettling(View child, @BottomSheetBehavior.StableState int state, boolean isReleasingView) {
    ...
    private int getTopOffsetForState(@BottomSheetBehavior.StableState int state) {
        switch (state) {
    ...
    private final ViewDragHelper.Callback dragCallback =
            new ViewDragHelper.Callback() {
                ...
                @Override
                public void onViewDragStateChanged(@BottomSheetBehavior.State int state) {
    ...
    private class StateSettlingTracker {
        ...
        void continueSettlingToState(@BottomSheetBehavior.State int targetState) {
            if (viewRef == null || viewRef.get() == null) {
                return;
            }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public static final Creator<BottomSheetBehavior.SavedState> CREATOR =
                new ClassLoaderCreator<BottomSheetBehavior.SavedState>() {
                    @NonNull
                    @Override
                    public BottomSheetBehavior.SavedState createFromParcel(@NonNull Parcel in, ClassLoader loader) {
                        return new BottomSheetBehavior.SavedState(in, loader);
                    }

                    @Nullable
                    @Override
                    public BottomSheetBehavior.SavedState createFromParcel(@NonNull Parcel in) {
                        return new BottomSheetBehavior.SavedState(in, null);
                    }
    ...
    private void replaceAccessibilityActionForState(
            View child, AccessibilityActionCompat action, @BottomSheetBehavior.State int state) {
        ViewCompat.replaceAccessibilityAction(
                child, action, null, createAccessibilityViewCommandForState(state));
    }

    private int addAccessibilityActionForState(
            View child, @StringRes int stringResId, @BottomSheetBehavior.State int state) {
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(@BottomSheetBehavior.State final int state) {
